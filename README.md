...
Data is the cornerstone of any Machine Learning project. For this project, the Iris dataset is loaded directly. The dataset is then used for training the model and testing the inference. This ensures that data handling remains separate from the core model operations.
